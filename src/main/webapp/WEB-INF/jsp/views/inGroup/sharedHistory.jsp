...
<body>
	<div id="contents">
		<form id="searchForm" method="get" action="${pageContext.request.contextPath}/sharedHistory.do" onsubmit="this.page.value=1; this.range.value=1;">
	...
	<script>
		...
		//처음 버튼 이벤트
		function fn_maxPrev() {
			var url = "${pageContext.request.contextPath}/sharedHistory.do";
			url = url + "?page=" + 1;
			url = url + "&range=" + 1;
			location.href = url;	}
		//이전 버튼 이벤트
