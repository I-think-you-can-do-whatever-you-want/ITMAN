...
<body>
	<div id="contents">
		<form id="searchForm" method="get" action="${pageContext.request.contextPath}/myShareHistory.do" onsubmit="this.page.value=1; this.range.value=1;">
		...
		<div class="Basic">
			<ul class="adminList history">
				...
				<li>
					<p class="admin">홍길동 부장</p>
					<p class="date">2025.07.16</p>
					<p class="tit">아이티맨 인사처</p>
					<p class="tit">권한 수정</p>
					<p class="etc">조회, 생성, 수정 -> 조회 </p>
				</li>
				<li>
					<p class="admin">홍길동 부장</p>
	...
	<script>
		...
		//처음 버튼 이벤트
		function fn_maxPrev() {
			var url = "${pageContext.request.contextPath}/myShareHistory.do";
			url = url + "?page=" + 1;
			url = url + "&range=" + 1;
			location.href = url;	}
		//이전 버튼 이벤트
