...
<body>
	...
	<div id="contents">
		<div class="tit_search">
			<h2>부서 관리</h2>
			<form  id="searchForm" name="searchForm" method="get" action="${pageContext.request.contextPath}/departList.do" onsubmit="this.page.value=1; this.range.value=1;">
...
<script>
	...
	//처음 버튼 이벤트
	function fn_maxPrev() {
		var url = "${pageContext.request.contextPath}/departList.do";
		url = url + "?page=" + 1;
		url = url + "&range=" + 1;
		location.href = url;	}
	//이전 버튼 이벤트
